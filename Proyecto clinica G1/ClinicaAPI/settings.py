"""
Django settings for ClinicaAPI project.
...
SECRET_KEY = 'django-insecure-_qdx+*@y+&!-%oj(m^0sdp9$jcamnxjxd45ea(w^3zzpv^7i%0'
...
WSGI_APPLICATION = 'ClinicaAPI.wsgi.application'
